...
LMCACHE_L2_ENABLED="${LMCACHE_L2_ENABLED:-false}"
LMCACHE_L2_HOST_PATH="${LMCACHE_L2_HOST_PATH:-/mnt/paas/lmcache/glm52-l2}"
LMCACHE_L2_MOUNT_PATH="${LMCACHE_L2_MOUNT_PATH:-/mnt/paas/lmcache/glm52-l2}"
LMCACHE_L2_MAX_CAPACITY_GB="${LMCACHE_L2_MAX_CAPACITY_GB:-10240}"
LMCACHE_L2_NUM_WORKERS="${LMCACHE_L2_NUM_WORKERS:-32}"
LMCACHE_L2_USE_ODIRECT="${LMCACHE_L2_USE_ODIRECT:-false}"
...
export IMAGE_NAME ARCH_NAME EMS_NAMESPACE NAMESPACE_ARCH EXECUTOR PIPELINE_NAME RUN_DIR RENDER_DIR DEPLOY_IMAGE \
  ...
  LMCACHE_L2_ENABLED LMCACHE_L2_HOST_PATH LMCACHE_L2_MOUNT_PATH \
  LMCACHE_L2_MAX_CAPACITY_GB LMCACHE_L2_NUM_WORKERS LMCACHE_L2_USE_ODIRECT \
  ...
  (
    umask 077
    {
      ...
      for variable in \
        ...
        XDS_DATABASE_NAME XDS_DATABASE_PORT XDS_DATABASE_USERNAME XDS_DATABASE_PASSWORD \
        LMCACHE_L2_ENABLED LMCACHE_L2_HOST_PATH LMCACHE_L2_MOUNT_PATH \
        LMCACHE_L2_MAX_CAPACITY_GB LMCACHE_L2_NUM_WORKERS LMCACHE_L2_USE_ODIRECT; do
        printf 'export %s=%q\n' "$variable" "${!variable}"
      done
    } >"$PIPELINE_ENV_FILE"
  )
