...
function loadOpenPlFormContext(overrides) {
  ...
  const context = Object.assign({
    ...
    normalizePipelineProm: value => value || {},
    normalizePipelineDefaults: value => value || { environmentIds: [], repositoryId: '', branch: 'main', strategy: '', presets: [] },
    currentPipelineDefaultSeed: () => ({ environmentIds: [], repositoryId: '', branch: 'main', strategy: '', presets: [] }),
