...
async function executeServerHttpStage(stage, runCtx, config, varsPool, deps, signal) {
  ...
  try {
    ...
    if (signal && signal.aborted) throw serverAbortReason(signal);
    const triggered = await serverFetchResponse(deps.fetchFn, triggerUrl, triggerOptions, deadline, isUrl ? "HTTP \u8BF7\u6C42" : "Jenkins \u89E6\u53D1", PIPELINE_REMOTE_TEXT_LIMIT, jobPath ? void 0 : signal);
